...
redo.analysis <- list(redo.importData = T,  # You'll need to set this to TRUE for your first time running
                      redo.cleanData = T,  # You'll need to set this to TRUE for your first time running
                      redo.rarefy = T,  # You'll need to set this to TRUE for your first time running
                      redo.alphaDiv = F,
                      redo.plots = F)
