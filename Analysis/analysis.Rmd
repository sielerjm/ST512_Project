...
Can we predict alpha diversity scores based on sex, body sub-site or the interaction of these two terms?
...
hist(sample_sums(ps.cleaned), main="Histogram: Read Counts before rarefaction", xlab="Total Reads",
     border="blue", col="green", las=1, breaks=12)
hist(sample_sums(ps.cleaned), main="Histogram: Read Counts after rarefaction", xlab="Total Reads",
     border="blue", col="green", las=1, breaks=12)
